...
export default function LoadingButton({
	...
	return (
		<div
			className={`bg-primary-600 flex relative justify-center items-center hover:bg-primary-700 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm w-${width} px-5 py-2.5`}
		>
