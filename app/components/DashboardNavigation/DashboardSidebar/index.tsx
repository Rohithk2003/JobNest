...
export default function Sidebar({
	...
	return (
		<aside
			className={`fixed ${
				fromMainPage != undefined || sideBarOpen ? "left-0" : "-left-[256px]"
			} top-0  w-64 z-[900] h-screen pt-14 transition-all duration-500 ease-out  bg-white border-r border-gray-200  dark:bg-transparent backdrop-blur-lg dark:border-gray-700`}
			aria-label="Sidenav"
