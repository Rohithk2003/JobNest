...
export default function LoadingButton({ text }: { text: string }) {
	return (
		<div className="bg-primary-600 flex relative justify-center items-center hover:bg-primary-700 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm w-max px-5 py-2.5">
