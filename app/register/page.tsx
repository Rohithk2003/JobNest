					...
					<div className="flex-1 flex items-center justify-center h-screen">
						<div className="w-full max-w-md space-y-8 px-4 bg-transparent text-gray-300 sm:px-0">
								...
								{googleProviderClicked ? (
									...
									<button
										...
										className={`flex items-center justify-center py-2.5 border rounded-lg ${
											signUpStarted
												? "opacity-30"
												: "opacity-1 hover:bg-indigo-500"
										} duration-150 active:bg-gray-100`}
									>
										<svg
											className="w-5 h-5"
											viewBox="0 0 48 48"
							...
							<div className="relative flex justify-center items-center">
								<p className="inline-block after:block after:w-32 after:h-[1.5px] after:absolute relative after:right-[120%] after:top-2 after:bg-gray-500 before:block before:w-32 before:h-[1.5px] before:absolute  before:left-[120%] before:top-2 before:bg-gray-500 w-fit text-sm bg-transparent  ">
									Or continue with
								</p>
							</div>
							{(error || showPopup) && (
